...
public class FileTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(f1.getTotalSpace()/1024/1024/1024); // 1024：单位的换算
        System.out.println(f1.getUsableSpace()/1024/1024/1024);


        System.out.println(f2.isHidden());
        System.out.println(new Date(f1.lastModified())); // f1最后一次修改的时间
...
//        f3.mkdirs();
        ...
        f1.renameTo(new File("new_writer.txt")); // 重命名
